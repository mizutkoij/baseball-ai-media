          ...
          <div className="bg-black/20 backdrop-blur-md border border-white/10 rounded-lg p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between text-sm">
                ...
                <span className="text-white">2025年8月8日</span>
              </div>
              <div className="flex justify-between text-sm">
          ...
          <div className="bg-black/20 backdrop-blur-md border border-white/10 rounded-lg p-6">
            ...
            <div className="space-y-3 text-sm">
              <div className="border-l-2 border-green-500 pl-3">
                <div className="text-white font-medium">2025.08.08</div>
                <div className="text-slate-400">2025年シーズンデータ統合・NPB係数更新</div>
              </div>
              <div className="border-l-2 border-blue-500 pl-3">
                <div className="text-white font-medium">2025.03.28</div>
                <div className="text-slate-400">NPB2025シーズン開幕対応・リアルタイム係数算出</div>
              </div>
